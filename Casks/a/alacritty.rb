cask "alacritty" do
  ...
  # Homebrew/homebrew-cask disabled the official "alacritty" cask on 2026-09-01
  # because alacritty is not notarized by Apple (fails the Gatekeeper check).
  # Upstream has stated they have no plans to pursue notarization, so this is
  # a self-hosted mirror of the same official .dmg/sha256 with the quarantine
  # attribute stripped after install, mirroring how aerospace.rb in this tap
  # already handles the same situation for another unsigned app.
  postflight do
